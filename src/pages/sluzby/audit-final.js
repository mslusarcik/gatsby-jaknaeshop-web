          ...
          <div className="content !py-0 !pl-0 flex flex-row items-center">
            <div className="xl:w-1/2 px-4 lg:pr-16">
              <h1 className="title uppercase h2">
                {/* Odhalte na e-shopu místa, která snižují vaše&nbsp;konverze */}
                Odhalte chyby, které zhoršují váš konverzní poměr
              </h1>
              <p className="">
                Neplýtvejte potenciálem svého e-shopu. Zvyšte prodeje a zlepšete
                uživatelskou zkušenost odkrytím nejslabších, ale i nejsilnějších
                míst svého e-shopu.
              </p>
              <ul className="mt-8">
                ...
                <li className="py-1 flex">
                  <BsFillCheckCircleFill className="fill-green-400"></BsFillCheckCircleFill>
                  <span className="pl-3">
                    Poznáte nejslabší a nejsilnější stránky na e-shopu
                  </span>
                </li>
                <li className="py-1 flex">
                  <BsFillCheckCircleFill className="fill-green-400"></BsFillCheckCircleFill>
                  <span className="pl-3">
                    Dostanete akční plán, který vás provede dalšími kroky
                  </span>
                </li>
              </ul>
              <form
 ...
 */
export const Head = () => (
  <Seo title="Zvyšte konverze svého e-shopu" bodyClass="type-course"></Seo>
)
