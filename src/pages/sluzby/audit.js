          ...
          <div className="content !py-0 !px-0 flex flex-row items-center">
            <div className="lg:w-1/2 px-4 lg:py-12 lg:pr-16">
              ...
              <span className="inline-block uppercase text-primary font-medium mb-4 px-4 py-2 text-[13px] lg:text-sm bg-secondary rounded-lg">
                Nenechte si utéct příležitost
              </span>
              <h1 className="title uppercase h2">
                Odhalte chyby, které&nbsp;zhoršují váš konverzní poměr
              </h1>
              <p className="text-lg">
                Neplýtvejte svým potenciálem. Brzy vám představím audit,
                kde&nbsp;
                <strong className="font-medium">
                  odkryju nejslabší a&nbsp;nejsilnější místa vašeho
                  e&#8209;shopu.
                </strong>
                .
              </p>
              <div className="flex flex-col lg:block">
                <ul className="mt-0 order-2">
                  <p className="text-lg font-medium mt-8">
                    Po spuštění služby můžete získat…
                  </p>
                  <li className="py-1 flex">
                    <BsFillCheckCircleFill className="fill-green-400"></BsFillCheckCircleFill>
                    <span className="pl-3">
                      komplexní video&#8209;audit a&nbsp;průchod nákupní cestou
                    </span>
                  </li>
                  <li className="py-1 flex">
                    <BsFillCheckCircleFill className="fill-green-400"></BsFillCheckCircleFill>
                    <span className="pl-3">
                      odhalení nejslabších a&nbsp;nejsilnějších stránek
                      e&#8209;shopu
                    </span>
                  </li>
                  <li className="py-1 flex">
                    <BsFillCheckCircleFill className="fill-green-400"></BsFillCheckCircleFill>
                    <span className="pl-3">
                      akční plán, který&nbsp;vás provede dalšími&nbsp;kroky
                    </span>
                  </li>
                </ul>
                <form
...
export const Head = () => (
  <Seo
    title="Zvyšte konverze svého e-shopu"
    bodyClass="type-course reset-header-xs"
  ></Seo>
)
